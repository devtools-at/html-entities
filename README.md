...
<p align="center">
  <a href="https://devtools.at/tools/html-entities"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Encode/decode HTML entities</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/html-entities">Try Online</a> •
...
**[Try HTML Entities online at DevTools.at →](https://devtools.at/tools/html-entities)**
...
Encode/decode HTML entities. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/html-entities';
